	...
	public class Database : IDisposable
	{
		...
		public Database(string connectionStringName = "")
		{
			...
			if (connectionStringName == "")
				connectionStringName = ConfigurationManager.ConnectionStrings["User_Management_Connection"].Name;
		...
		public IEnumerable<T> Query<T>(string sql, params object[] args)
		{
			...
			{
				// sql = sql.ToLower();
				//sql = sql.Replace("exec ", "exec dbo.");
				//MicroInsure.classes.ClsRequests.LogError(_sharedConnection.ConnectionString);
				using (var cmd = CreateCommand(_sharedConnection, sql, args))
				{
					IDataReader r;
